package com.meu.myproject.ui.adapter;
...
import com.meu.myproject.databinding.MatchItemBinding;
import com.meu.myproject.domain.Match;
import com.meu.myproject.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Aqui embaixo eu estou falando que o tvHomeTeamScore "O PLACAR", vai receber o valor de score "(match.getHomeTeam().getScore())".
